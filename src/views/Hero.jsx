  ...
  return (
    ...
    >
      ...
      <FadeIn delay={0.2} direction="up" padding fullWidth>
        <div className="relative w-4/12 xs:w-[460px] mt-11">
          <input
            type="text"
            placeholder="Search"
            className="rounded-full w-full pl-6 pr-[68px] py-4 bg-primary outline-none text-gray
              text-base xs:text-lg placeholder-slate-300"
          />
          <img
            src={searchIcon}
            alt=""
